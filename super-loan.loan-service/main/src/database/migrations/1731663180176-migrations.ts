...
export class Migrations1731663180176 implements MigrationInterface {
  name = 'Migrations1731663180176';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "borrower_profiles" ADD "personal_email" character varying(100)`);
    await queryRunner.query(`ALTER TABLE "borrower_profiles" ADD "work_email" character varying(100)`);
    await queryRunner.query(`ALTER TABLE "borrower_profiles" DROP COLUMN "phone_number"`);
    await queryRunner.query(`ALTER TABLE "borrower_profiles" ADD "phone_number" character varying(15)`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "borrower_profiles" DROP COLUMN "work_email"`);
    await queryRunner.query(`ALTER TABLE "borrower_profiles" DROP COLUMN "personal_email"`);
